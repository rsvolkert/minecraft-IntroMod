...
import com.rvolkert.intromod.block.custom.*;
import com.rvolkert.intromod.fluid.ModFluids;
import com.rvolkert.intromod.item.ModItems;
import com.rvolkert.intromod.world.feature.tree.RedMapleTreeGrower;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> ZIRCON_ORE = registerBlock("zirconore",
        () -> new DropExperienceBlock(BlockBehaviour.Properties.of(Material.STONE)
                .strength(6f).requiresCorrectToolForDrops(),
                UniformInt.of(3, 7)));
    public static final RegistryObject<Block> DEEPSLATE_ZIRCON_ORE = registerBlock("deepslate_zirconore",
        () -> new DropExperienceBlock(BlockBehaviour.Properties.of(Material.STONE)
                .strength(6f).requiresCorrectToolForDrops(),
                UniformInt.of(3, 7)));
